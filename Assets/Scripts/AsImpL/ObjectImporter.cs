...
{
    /// <summary>
    /// Component that imports objects from a model, both at run-time and as assets in Editor.
    /// </summary>
    /// <remarks></remarks>
    public class ObjectImporter : MonoBehaviour
    {
        ...
        /// </summary>
        public static event Action ImportingStart;

        /// <summary>
        /// Event triggered when finished importing.
        /// </summary>
        public static event Action ImportingComplete;

        /// <summary>
        /// Event triggered when a single model has been created and before it is imported.
        /// </summary>
        public static event Action<GameObject, string> CreatedModel;

        /// <summary>
        /// Event triggered when a single model has been successfully imported.
        /// </summary>
        public static event Action<GameObject, string> ImportedModel;

        /// <summary>
        /// Event triggered when an error occurred importing a model.
        /// </summary>
        public static event Action<string> ImportError;
