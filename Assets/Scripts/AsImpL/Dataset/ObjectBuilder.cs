...
namespace AsImpL
{
    ...
    public class ObjectBuilder
    {
        ...
        public static Action<GameObject> ObjectBuilt;
        ...
        protected bool BuildNextObject(GameObject parentObj, Dictionary<string, Material> mats)
        {
            ...
            ObjectBuilt?.Invoke(buildStatus.currObjGameObject);
        ...
        protected void FinalizeObject(GameObject incompleteObj, Mesh mesh)
        {
            ...
            // Step 1: Get world center of the mesh
            Vector3 worldCenter = incompleteObj.transform.TransformPoint(mesh.bounds.center);

            // Step 2: Move the GameObject to the mesh's world center
            incompleteObj.transform.position = worldCenter;

            // Step 3: Recenter the mesh vertices
        ...
        protected Material GetLibraryMaterial(Dictionary<string, Material> materialLibrary, string materialName)
        {
            ...
            {
                defaultMaterial = ContentLoader.Instance.Categories.Find(category => category.name == "Environment").Material;
            }
            Material material = defaultMaterial;
            // string matName = materialName ?? "default";
